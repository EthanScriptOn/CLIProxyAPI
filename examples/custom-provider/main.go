...
import (
	...
	"proxycore/api/v6/sdk/api"
	sdkAuth "proxycore/api/v6/sdk/auth"
	"proxycore/api/v6/sdk/cliproxy"
	coreauth "proxycore/api/v6/sdk/cliproxy/auth"
	clipexec "proxycore/api/v6/sdk/cliproxy/executor"
	"proxycore/api/v6/sdk/config"
	"proxycore/api/v6/sdk/logging"
	sdktr "proxycore/api/v6/sdk/translator"
)
