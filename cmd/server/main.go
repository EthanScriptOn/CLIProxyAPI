...
import (
	...
	_ "proxycore/api/v6/internal/translator"
	"proxycore/api/v6/internal/tui"
...
func main() {
	fmt.Printf("ProxyCore Version: %s, Commit: %s, BuiltAt: %s\n", buildinfo.Version, buildinfo.Commit, buildinfo.BuildDate)
	...
	usage.InitPersistence(configFilePath)
